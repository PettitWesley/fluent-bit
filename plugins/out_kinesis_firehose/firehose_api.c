 ...
 */
static int write_event(struct flb_cloudwatch *ctx, struct flush *buf,
 ...
 */
int process_event(struct flb_cloudwatch *ctx, struct flush *buf,
...
void reset_flush_buf(struct flb_cloudwatch *ctx, struct flush *buf,
...
int send_log_events(struct flb_cloudwatch *ctx, struct flush *buf,
                    struct log_stream *stream) {
    int ret;
    int offset;
    int i;
 ...
 */
int add_event(struct flb_cloudwatch *ctx, struct flush *buf,
              struct log_stream *stream,
              const msgpack_object *obj, struct flb_time *tms)
{
    int ret;
