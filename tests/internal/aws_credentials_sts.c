                      ...
                      int method, const char *uri)
{
    ...
    call_count++;
    /*
     * First call to get_credentials should lead to an API call. Second
                          ...
                          int method, const char *uri)
{
    ...
    call_count++;
    /*
     * Since the API returns an error, each call to get_credentials or
     * refresh will lead to an API request.
     */
    TEST_CHECK(call_count == 3);
